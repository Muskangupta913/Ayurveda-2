  ...
  return (
    <>
      ...
      <button
        ...
        className={clsx(
          "fixed top-4 left-4 z-[60] bg-gradient-to-r from-blue-600 to-indigo-600 text-white p-3 rounded-xl shadow-lg hover:shadow-xl transition-all duration-300 hover:scale-105 border border-white/20 backdrop-blur-sm",
          {
      ...
      <aside className={clsx(
        'transition-all duration-300 ease-in-out bg-gradient-to-br from-blue-900 via-indigo-800 to-purple-700 text-white shadow-2xl relative overflow-hidden flex-col min-h-screen w-72',
        {
      ...
      <aside className={clsx(
        ...
        <div className="relative z-10 flex flex-col h-full">
          ...
          {/* <div className="mt-auto p-4 border-t border-white/20">
            <div className="bg-gradient-to-r from-blue-600/50 to-indigo-600/50 backdrop-blur-sm rounded-xl p-4 border border-white/20">
              <div className="flex items-center space-x-3">
                <div className="w-10 h-10 bg-gradient-to-br from-cyan-400 to-cyan-600 rounded-full flex items-center justify-center shadow-lg flex-shrink-0">
                  <span className="text-white font-bold text-sm">C</span>
                </div>
                <div className="flex-1 min-w-0">
                  <div className="text-white font-medium text-sm truncate">Clinic Manager</div>
                  <div className="text-blue-200 text-xs opacity-80 truncate">Healthcare Professional</div>
                </div>
              </div>
            </div>
          </div> */}
