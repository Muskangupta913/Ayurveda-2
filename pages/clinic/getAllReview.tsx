 ...
 return (
  <div className="min-h-screen bg-gray-50 p-3 sm:p-4 lg:p-6">
    <div className="max-w-7xl mx-auto">
      ...
      {error ? (
        <div className="bg-red-50 border border-red-200 rounded-lg p-4 sm:p-6 mb-6 shadow-sm">
        ...
        <>
            ...
            <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 gap-4 sm:gap-6 mb-6 sm:mb-8">
              <div className="bg-white rounded-lg shadow-sm border border-gray-200 p-4 sm:p-6 hover:shadow-md transition-all duration-200">
                <div className="flex items-center justify-between">
                  ...
                  <div className="w-10 h-10 sm:w-12 sm:h-12 bg-[#2D9AA5]/10 rounded-full flex items-center justify-center">
                    <MessageSquare className="w-5 h-5 sm:w-6 sm:h-6 text-[#2D9AA5]" />
                  </div>
                </div>
              </div>
              ...
              <div className="bg-white rounded-lg shadow-sm border border-gray-200 p-4 sm:p-6 hover:shadow-md transition-all duration-200">
                <div className="flex items-center justify-between">
                  ...
                  <div className="w-10 h-10 sm:w-12 sm:h-12 bg-yellow-100 rounded-full flex items-center justify-center">
                    <Star className="w-5 h-5 sm:w-6 sm:h-6 text-yellow-600 fill-current" />
                  </div>
                </div>
              </div>

              <div className="bg-white rounded-lg shadow-sm border border-gray-200 p-4 sm:p-6 hover:shadow-md transition-all duration-200 sm:col-span-2 lg:col-span-1">
                <div className="flex items-center justify-between mb-4">
                  <div className="text-gray-600 font-medium text-sm sm:text-base">
                    Rating Distribution
                  </div>
                  <TrendingUp className="w-4 h-4 sm:w-5 sm:h-5 text-[#2D9AA5]" />
                </div>
                <div className="space-y-2">
                  {[5, 4, 3, 2, 1].map((rating) => (
                    <div key={rating} className="flex items-center text-xs sm:text-sm">
                      <span className="w-2 sm:w-3 text-gray-900 font-medium">
                        {rating}
                      </span>
                      <Star className="w-3 h-3 fill-yellow-400 text-yellow-400 mx-1 sm:mx-2" />
                      <div className="flex-1 bg-gray-200 rounded-full h-1.5 sm:h-2 mx-1 sm:mx-2">
                        <div
                          className="bg-[#2D9AA5] h-1.5 sm:h-2 rounded-full transition-all duration-300"
                          style={{
            ...
            <div className="flex flex-col sm:flex-row gap-4">
              ...
              <div className="flex-1 relative">
                ...
                <input
                  ...
                  className="w-full pl-10 sm:pl-12 pr-3 sm:pr-4 py-2.5 sm:py-3 border border-gray-200 rounded-lg focus:ring-2 focus:ring-[#2D9AA5] focus:border-[#2D9AA5] text-gray-900 bg-gray-50 hover:bg-white transition-colors duration-200 text-sm sm:text-base"
                />
              </div>
              ...
              <div className="flex items-center gap-2 sm:gap-3">
                ...
                <select
                  ...
                  className="px-3 sm:px-4 py-2.5 sm:py-3 border border-gray-200 rounded-lg focus:ring-2 focus:ring-[#2D9AA5] focus:border-[#2D9AA5] text-gray-900 bg-gray-50 hover:bg-white transition-colors duration-200 min-w-[120px] sm:min-w-[140px] text-sm sm:text-base"
                >
          ...
          {filteredReviews.length === 0 ? (
            <div className="bg-white rounded-lg shadow-sm border border-gray-200 p-6 sm:p-8 md:p-12 text-center">
              <div className="w-12 h-12 sm:w-16 sm:h-16 md:w-20 md:h-20 bg-gray-100 rounded-full flex items-center justify-center mx-auto mb-3 sm:mb-4 md:mb-6">
