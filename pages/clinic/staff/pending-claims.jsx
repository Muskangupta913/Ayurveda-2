...
function PatientsPage() {
  ...
  const fetchPatients = async () => {
    ...
    try {
      ...
      const res = await axios.get("/api/clinic/pending-claims", { headers: getAuthHeader(), params });
  ...
  const submitRelease = async () => {
    ...
    try {
      ...
      const res = await axios.patch("/api/clinic/pending-claims", body, { headers: getAuthHeader() });
