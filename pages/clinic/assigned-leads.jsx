                  ...
                  <div className="grid grid-cols-1 gap-6 px-6 py-5 xl:grid-cols-12">
                    ...
                    <div className="flex flex-col items-end gap-3 xl:col-span-1 min-w-0">
                      <button
                        ...
                        className="inline-flex items-center justify-center gap-2 rounded-xl bg-gradient-to-r from-emerald-500 to-green-600 px-4 py-2.5 text-xs font-semibold text-white shadow-lg shadow-emerald-200 transition-all hover:from-emerald-600 hover:to-green-700 hover:shadow-xl whitespace-nowrap w-full xl:w-full max-w-full"
                      >
                        <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" stroke="currentColor" strokeWidth={2.5} className="h-5 w-5 flex-shrink-0">
                          <path strokeLinecap="round" strokeLinejoin="round" d="M8 10h.01M12 10h.01M16 10h.01M21 12a9 9 0 11-18 0 9 9 0 0118 0z" />
                        </svg>
                        <span className="whitespace-nowrap">Quick chat</span>
                      </button>
