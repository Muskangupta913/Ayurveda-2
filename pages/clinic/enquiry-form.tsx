        ...
        <div className="grid lg:grid-cols-2 min-h-[600px]">
          ...
          >
            <div className="space-y-6 sm:space-y-8">
              <div>
                <h1 className="text-2xl sm:text-3xl lg:text-4xl font-bold mb-3 sm:mb-4 leading-tight">{clinicName}</h1>
                <div className="flex items-start space-x-3 mb-4 sm:mb-6">
                  <MapPin className="w-4 h-4 sm:w-5 sm:h-5 mt-1 flex-shrink-0" style={{ color: '#A7F3D0' }} />
                  <p className="text-sm sm:text-base lg:text-lg" style={{ color: '#A7F3D0' }}>{clinicAddress}</p>
                </div>
              </div>

              <div className="space-y-4 sm:space-y-6">
                <div className="flex items-center space-x-3 sm:space-x-4 p-3 sm:p-4 bg-white/10 rounded-xl backdrop-blur-sm">
                  <Clock className="w-5 h-5 sm:w-6 sm:h-6 flex-shrink-0" style={{ color: '#A7F3D0' }} />
                  <div className="min-w-0">
                    <p className="font-semibold text-sm sm:text-base" style={{ color: '#A7F3D0' }}>Operating Hours</p>
                    <p className="text-white text-sm sm:text-base break-words">{clinicDetails.timings}</p>
                  </div>
                </div>

                <div className="flex items-center space-x-3 sm:space-x-4 p-3 sm:p-4 bg-white/10 rounded-xl backdrop-blur-sm">
                  <DollarSign className="w-5 h-5 sm:w-6 sm:h-6 flex-shrink-0" style={{ color: '#A7F3D0' }} />
                  <div className="min-w-0">
                    <p className="font-semibold text-sm sm:text-base" style={{ color: '#A7F3D0' }}>Consultation Fees</p>
                    <p className="text-white text-sm sm:text-base break-words">{clinicDetails.pricing}</p>
                  </div>
                </div>
              </div>

              <div className="pt-2 sm:pt-4">
                <p className="text-sm sm:text-base lg:text-lg" style={{ color: '#A7F3D0' }}>
                  Ready to book your appointment? Fill out the form and we&apos;ll get back to you shortly.
                </p>
              </div>
            </div>
          </div>
          ...
          <div className="p-4 sm:p-6 lg:p-12 flex flex-col justify-center">
            {submitted ? (
              <div className="text-center space-y-4">
                ...
                <h2 className="text-xl sm:text-2xl font-bold text-gray-800">Thank You!</h2>
                <p className="text-gray-600 text-base sm:text-lg px-4">Your enquiry has been sent successfully. We&apos;ll contact you soon.</p>
              ...
              <div>
                <h2 className="text-xl sm:text-2xl lg:text-3xl font-bold text-gray-800 mb-2">Send Enquiry</h2>
                <p className="text-gray-600 mb-6 sm:mb-8 text-sm sm:text-base">Get in touch with us for appointments and consultations</p>
