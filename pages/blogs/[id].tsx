...
export default function BlogDetail({ initialBlog, seo }: BlogDetailProps) {
  ...
  return (
    <div className="min-h-screen bg-gradient-to-br from-gray-50 to-gray-100">
      ...
      .blog-content p:not(:has(img)):not(:has(video)) {
      ...
      <div className="blog-container">
          ...
          <div className="relative max-w-5xl mx-auto px-6 py-16">
            ...
            <div className="max-w-4xl mx-auto text-center mb-16">
              ...
              <div className="flex items-center justify-center space-x-6 mb-12">
                ...
                >
                  <svg
                    className={`w-6 h-6 transition-all duration-200 hover:scale-110 ${blog.liked ? 'text-red-500' : 'text-gray-400 hover:text-red-400'}`}
                  ...
                  <div className="text-left">
                    <span className="font-semibold text-lg">{blog.likesCount}</span>
                    <p className="text-sm opacity-70">{blog.likesCount === 1 ? "" : ""}</p>
                  </div>
                </button>
                ...
                >
                  <svg viewBox="0 0 24 24" className="w-6 h-6 text-gray-500 hover:text-blue-500 transition-colors duration-200">
                    <path d="M21.99 4c0-1.1-.89-2-2-2H4c-1.1 0-2 .9-2 2v12c0 1.1.9 2 2 2h14l4 4-.01-18zM18 14H6v-2h12v2zm0-3H6V9h12v2zm0-3H6V6h12v2z"
                      fill="currentColor" />
                  </svg>
                  <div className="text-left">
                    <span className="font-semibold text-lg">{blog.comments.length}</span>
                    <p className="text-sm opacity-70">{blog.comments.length === 1 ? "" : ""}</p>
                  </div>
                </button>
        ...
        <section id="comments-section">
          <div className="space-y-8 mb-16">
            {blog.comments.slice(0, showAllComments ? blog.comments.length : 4).map((c) => {
              ...
              return (
                <div key={c._id} className="bg-gradient-to-br from-gray-50 to-white rounded-2xl p-8 hover:shadow-lg transition-all duration-300 border border-gray-100">
                  <div className="flex justify-between items-start mb-4">
                    <div className="flex items-center space-x-4">
                      ...
                      <div>
                        <p className="font-bold text-gray-900 text-lg">{c.username}</p>
                        ...
                        return (
                          <div key={r._id} className={`p-6 rounded-xl ${isAuthorReply ? "bg-gradient-to-br from-[#2D9AA5]/10 to-[#2D9AA5]/5 border-2 border-[#2D9AA5]/20" : "bg-white border border-gray-200"}`}>
                            <div className="flex justify-between items-start mb-3">
                              <div className="flex items-center space-x-3">
                                <div className={`w-8 h-8 rounded-full flex items-center justify-center text-white font-bold text-sm ${isAuthorReply ? "bg-gradient-to-br from-[#2D9AA5] to-[#236b73]" : "bg-gradient-to-br from-gray-400 to-gray-500"}`}>
                                  {r.username.charAt(0).toUpperCase()}
                                </div>
                                <div>
                                  <p className={`font-bold text-sm flex items-center ${isAuthorReply ? "text-[#2D9AA5]" : "text-gray-700"}`}>
                                    {r.username}
                                    {isAuthorReply && <span className="ml-2 text-xs bg-[#2D9AA5] text-white px-3 py-1 rounded-full">Author</span>}
                                  </p>
                            ...
                            <pre className="text-gray-700 text-sm leading-relaxed whitespace-pre-wrap font-sans">{r.text}</pre>
                          </div>
                        );
                      })}
                    </div>
          ...
          <div className="border-t-2 border-gray-100 pt-12">
            <div className="text-center mb-8">
              <h3 className="text-2xl font-bold mb-2 text-gray-900">Share Your Thoughts</h3>
              <p className="text-gray-600">We'd love to hear your perspective on this article</p>
            </div>
