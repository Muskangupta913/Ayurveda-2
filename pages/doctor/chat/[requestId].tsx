      ...
      <div className="flex-1 bg-gradient-to-br from-[#0B141A] via-[#1A252E] to-[#0B141A] flex items-center justify-center p-6 relative overflow-hidden">
        ...
        <div className="text-center relative z-10 max-w-lg mx-auto">
          <div className="relative mb-8">
            <div className="w-28 h-28 rounded-full bg-gradient-to-br from-[#2D9AA5] to-[#2D9AA5]/80 flex items-center justify-center mx-auto shadow-2xl backdrop-blur-sm">
              <div className="w-20 h-20 rounded-full bg-gradient-to-br from-white/20 to-white/10 flex items-center justify-center backdrop-blur-sm">
                <span className="text-4xl">💬</span>
              </div>
            </div>
            <div className="absolute -top-2 -right-2 w-8 h-8 bg-[#4CAF50] rounded-full animate-bounce shadow-lg flex items-center justify-center">
          ...
          <div className="mt-8 flex items-center justify-center space-x-2 text-[#2D9AA5]">
            <div className="w-2 h-2 bg-[#2D9AA5] rounded-full animate-pulse"></div>
            <div className="w-2 h-2 bg-[#2D9AA5] rounded-full animate-pulse delay-200"></div>
            <div className="w-2 h-2 bg-[#2D9AA5] rounded-full animate-pulse delay-400"></div>
          </div>
        </div>
        ...
        <div className="w-full max-w-6xl mx-auto">
          <div className="flex items-center space-x-2">
            ...
            <button
              ...
              className={`p-2.5 rounded-full transition-all duration-200 shadow-xl ${
      ...
      <div className="w-full max-w-6xl mx-auto">
        <div className="flex items-center space-x-2">
          ...
          <button
            onClick={sendMessage}
            disabled={sending || !message.trim()}
            className={`p-2.5 sm:p-3 rounded-full transition-all duration-200 shadow-xl ${
              message.trim() && !sending
                ? 'bg-gradient-to-r from-[#2D9AA5] to-[#2D9AA5]/90 text-white hover:shadow-2xl hover:scale-110 hover:rotate-12'
                : 'bg-gray-600 text-gray-400 cursor-not-allowed'
            }`}
