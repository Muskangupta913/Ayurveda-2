...
DoctorPrescriptionRequests.getLayout = function PageLayout(page: React.ReactNode) {
  return <DoctorLayout>{page}</DoctorLayout>;
};

const ProtectedDoctorPrescriptionRequests: NextPageWithLayout = withDoctorAuth(DoctorPrescriptionRequests);
ProtectedDoctorPrescriptionRequests.getLayout = DoctorPrescriptionRequests.getLayout;
