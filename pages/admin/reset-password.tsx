...
const ResetAdminPasswordPage: NextPageWithLayout = () => {
  ...
  const handleReset = async (e: React.FormEvent<HTMLFormElement>) => {
    ...
    try {
      const res = await axios.post('/api/admin/reset-password', { email, password });
      if (res.status === 200) {
        setShowSuccess(true);
      }
    } catch (err) {
    ...
    <div className="min-h-screen bg-gradient-to-br from-blue-50 via-white to-indigo-50 flex items-center justify-center p-4">
      <div className="w-full max-w-md">
        ...
        <div className="text-center mb-8">
          ...
          <h2 className="text-3xl font-bold text-gray-900 mb-2">Reset Admin Password</h2>
          <p className="text-gray-600">Create a new secure password for your administrator account</p>
        </div>
        ...
        <div className="bg-white rounded-2xl shadow-xl border border-gray-100 overflow-hidden">
          ...
          <div className="bg-gray-50 px-8 py-4 border-t border-gray-100">
            <div className="flex items-center justify-center text-sm text-gray-600">
              ...
              <Link href="/admin" className="text-blue-600 hover:text-blue-500 font-medium ml-1">
                Sign in instead
              </Link>
            </div>
          </div>
        ...
        <div className="fixed inset-0 flex items-center justify-center bg-black bg-opacity-50 z-50 p-4">
          <div className="bg-white rounded-2xl shadow-2xl max-w-sm w-full overflow-hidden transform transition-all">
            <div className="p-6 text-center">
              ...
              <p className="text-gray-600 mb-6">Your admin password has been updated. You can now sign in with your new password.</p>
              <button
