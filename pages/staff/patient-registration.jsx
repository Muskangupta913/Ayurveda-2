...
const InvoiceManagementSystem = () => {
  ...
  const validateForm = useCallback(() => {
    const newErrors = {};
    const { invoiceNumber, emrNumber, firstName, lastName, email, gender, doctor, service, treatment, patientType, amount, paymentMethod, insurance, advanceGivenAmount, coPayPercent } = formData;
    ...
    else if (usedEMRNumbers.has(emrNumber)) newErrors.emrNumber = "EMR Number already exists. Must be unique.";
  ...
  const handleSubmit = useCallback(() => {
    if (validateForm()) {
      ...
      const invoiceData = { ...formData, ...autoFields, calculatedFields };
