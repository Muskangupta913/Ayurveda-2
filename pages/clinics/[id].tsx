...
import { Star, MessageCircle, Navigation, MapPin, Clock, Award, Calendar, Phone, Users, ChevronRight } from "lucide-react";
...
export default function ClinicDetail() {
    ...
    if (error || !clinic)
        return <div className="min-h-screen flex items-center justify-center">{error || "Not found"}</div>;
