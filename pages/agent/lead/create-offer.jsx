    ...
    try {
      ...
      if (data.success && data.data) {
        ...
        if (modulePermission) {
          ...
          console.log("Permission Actions:", actions);
          
          // If actions.all is true, grant all permissions
          // Otherwise, check individual action flags
          const hasAll = actions.all === true;
          
          setPermissions({
            // If "all" is true, grant all permissions, otherwise check individual flags
            canCreate: hasAll || actions.create === true,
            canUpdate: hasAll || actions.update === true,
            canDelete: hasAll || actions.delete === true,
            canRead: hasAll || actions.read === true,
          });
          ...
          console.log("No module permission found for create_offers");
          setPermissions({
            canCreate: false,
            canUpdate: false,
            canDelete: false,
        ...
        console.log("API failed or no data:", data);
        setPermissions({
          canCreate: false,
          canUpdate: false,
          canDelete: false,
