...
function PatientsPage() {
  ...
  useEffect(() => {
    ...
    axios.get("/api/agent/patient-registration", { headers })
      .then(res => {
  ...
  const fetchPatients = async () => {
    ...
    try {
      ...
      const res = await axios.get("/api/agent/pending-claims", { headers: getAuthHeader(), params });
  ...
  const submitRelease = async () => {
    ...
    try {
      ...
      const res = await axios.patch("/api/agent/pending-claims", body, { headers: getAuthHeader() });
...
const ProtectedDashboard = withAgentAuth(PatientsPage);
